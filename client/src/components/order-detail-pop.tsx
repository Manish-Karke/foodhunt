// OrderDetailPopup.tsx
"use client";

import { useEffect, useState } from "react";
import axios from "axios";
import Steppers, { type OrderStatus } from "@/components/order-status";
        ...
        {order && (
          <>
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <div className="relative">
                <button
                  data-popover-target="invoice-popover"
                  data-popover-placement="bottom"
                  data-popover-trigger="hover"
                  className="text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center"
                >
                  Download Invoice
                </button>
                <div
                ...
                >
                  ...
                  <div className="px-3 py-2">
                    <p>Download the invoice for this order as a PDF.</p>
                  </div>
                  <div data-popper-arrow></div>
                </div>
              </div>
