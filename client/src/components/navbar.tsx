...
const foodCategories = {
  nonVeg: [
    ...
    {
      name: "Fish",
      items: ["Fish Curry", "Grilled Fish", "Fish Fry", "Fish Biryani"],
    },
  ],
  veg: [
    {
      name: "Traditional Nepali",
      items: ["Dal Bhat", "Gundruk", "Aloo Tama", "Dhido"],
    },
    { name: "Newari Cuisine", items: ["Bara", "Chatamari", "Yomari", "Kwati"] },
    {
      name: "Chinese",
      items: ["Veg Fried Rice", "Chow Mein", "Manchurian", "Spring Rolls"],
    },
    {
      name: "Snacks & Street Food",
      items: ["Sel Roti", "Samosa", "Pani Puri", "Jeri"],
    },
  ],
};
...
const drinks = [
  {
    name: "Hot Beverages",
    items: ["Coffee", "Tea", "Hot Chocolate", "Masala Chai"],
  },
  {
    name: "Cold Beverages",
    items: ["Fresh Juice", "Smoothies", "Iced Coffee", "Mocktails"],
  },
  { name: "Soft Drinks", items: ["Coke", "Pepsi", "Sprite", "Fanta"] },
  {
    name: "Healthy Drinks",
    items: ["Green Tea", "Herbal Tea", "Coconut Water", "Lemon Water"],
  },
];
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className="grid w-[600px] grid-cols-2 gap-6 p-6">
                    {drinks.map((category) => (
                      <div key={category.name}>
                        <h4 className="mb-3 font-medium text-orange-600">
                          {category.name}
                        </h4>
                        <div className="grid gap-1">
                          {category.items.map((item) => (
